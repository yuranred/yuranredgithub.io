...
// load widget
add_action( 'widgets_init', 'czs_ads_widgets' );

// Register widget
function czs_ads_widgets() {
	register_widget( 'czs_Ad_Widget' );
}

// Widget class
class czs_ad_widget extends WP_Widget {
...
function __construct() {
	...
	// Widget settings
	$widget_ops = array (
		'classname' => 'czs_ad_widget',
		'description' => __('A widget for 125 x 125 ad unit (max 6 ads)', 'czs')
	);
	...
	$control_ops = array (
		'width' => 300,
		'height' => 350,
		'id_base' => 'czs_ad_widget'
	);

	// Create the widget
	parent::__construct( 'czs_ad_widget', __('125x125 Ads', 'czs'), $widget_ops, $control_ops );
...
function form( $instance ) {
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad1' ); ?>"><?php _e('Ad 1 image url:', 'czs') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link1' ); ?>"><?php _e('Ad 1 link url:', 'czs') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad2' ); ?>"><?php _e('Ad 2 image url:', 'czs') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link2' ); ?>"><?php _e('Ad 2 link url:', 'czs') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad3' ); ?>"><?php _e('Ad 3 image url:', 'czs') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link3' ); ?>"><?php _e('Ad 3 link url:', 'czs') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad4' ); ?>"><?php _e('Ad 4 image url:', 'czs') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link4' ); ?>"><?php _e('Ad 4 link url:', 'czs') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad5' ); ?>"><?php _e('Ad 5 image url:', 'czs') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link5' ); ?>"><?php _e('Ad 5 link url:', 'czs') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad6' ); ?>"><?php _e('Ad 6 image url:', 'czs') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link6' ); ?>"><?php _e('Ad 6 link url:', 'czs') ?></label>
	...
	<!-- Randomize? -->
	<p>
		<label for="<?php echo $this->get_field_id( 'random' ); ?>"><?php _e('Randomize ads order?', 'czs') ?></label>
