...
<div class="tab-content" id="div_tab4"<?php echo $tab == 4 ? ' style="display: block;"' : ''; ?>>
    <fieldset>
        ...
        <tr>
            ...
            <b>Внимание!</b> Для работы данного метода обновления Вам потребуется настроить CRON-задание на Вашем сервере (хостинге) <a href="http://wpgrabber.ru/faq/33-kak-nastroit-avto-obnovlenie-lent-v-wpgrabber-ispolzuya-cron-na-servere" target="_blank">( подробнее )</a>
            </div>
            </td>
        </tr>
        <tr>
